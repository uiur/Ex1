...
% 外部仕様とは，ユーザから見えるプログラムの機能，振舞い，使用法などを
% 記述したものである．
...
% 端末で入出力されるデータ，およびファイルから入出力されるデータについて
% 説明する．後者について，なければ「なし」と明記．
% {itemize} または {description} で記述．
